    ...
    return function e(t, n, r) {
        ...
        return s
            ...
            2 : [function(require, module, exports) {
                ...
                {}],
            3 : [function(require, module, exports) { (function(definition) {
            ...
            7 : [function(require, module, exports) { (function(process, global) {
                "use strict";
            ...
            10 : [function(require, module, exports) { (function(global) {
                ...
                function polyfill() {
                    ...
                    var es6PromiseSupport = "Promise" in local && "cast" in local.Promise && "resolve" in local.Promise && "reject" in local.Promise && "all" in local.Promise && "race" in local.Promise &&
                        function() {
                            var resolve;
            ...
            16 : [function(require, module, exports) {
                ...
                {}],
            17 : [function(require, module, exports) { (function(global, factory) {
            ...
            19 : [function(require, module, exports) { (function() {
            ...
            20 : [function(require, module, exports) { (function() {
                var $, Util;
                $ = require("jquery");
                Util = {};
                Util.NodeTypes = {
            ...
            21 : [function(require, module, exports) { (function() {
            ...
            22 : [function(require, module, exports) {
                ...
                App.prototype.start = function() {
                    ...
                    this.annotations = new storage.StorageAdapter(reg.getUtility("storage"),
                        function() {
                ...
                App.prototype.runHook = function(name, args) {
                    var results = [];
                    for (var i = 0,
                             len = this.modules.length; i < len; i++) {
            ...
            29 : [function(require, module, exports) {
                ...
                var Adder = Widget.extend({
                    constructor: function(options) {
                        ...
                        var self = this;
                        this.element.on("click." + NS, "button",
                            function(e) {
                                self._onClick(e)
                            }).on("mousedown." + NS, "button",
                            function(e) {
                                self._onMousedown(e)
                            });
                        this.document = this.element[0].ownerDocument;
                        $(this.document.body).on("mouseup." + NS,
                            function(e) {
                                self._onMouseup(e)
                            })
                    },
            ...
            30 : [function(require, module, exports) {
                ...
                var Editor = exports.Editor = Widget.extend({
                    constructor: function(options) {
                        ...
                        var self = this;
                        this.element.on("submit." + NS, "form",
                            function(e) {
                                self._onFormSubmit(e)
                            }).on("click." + NS, ".annotator-save",
                            function(e) {
                                self._onSaveClick(e)
                            }).on("click." + NS, ".annotator-cancel",
                            function(e) {
                                self._onCancelClick(e)
                            }).on("mouseover." + NS, ".annotator-cancel",
                            function(e) {
                                self._onCancelMouseover(e)
                            }).on("keydown." + NS, "textarea",
                            function(e) {
            ...
            31 : [function(require, module, exports) {
                ...
                var Filter = exports.Filter = function Filter(options) {
                    ...
                    this.current = 0;
                    for (var i = 0,
                             len = this.options.filters.length; i < len; i++) {
                    ...
                    var filterInput = ".annotator-filter-property input",
                        self = this;
                    this.element.on("focus." + NS, filterInput,
                        function(e) {
                            self._onFilterFocus(e)
                        }).on("blur." + NS, filterInput,
                        function(e) {
                            self._onFilterBlur(e)
                        }).on("keyup." + NS, filterInput,
                        function(e) {
                            self._onFilterKeyup(e)
                        }).on("click." + NS, ".annotator-filter-previous",
                        function(e) {
                            self._onPreviousClick(e)
                        }).on("click." + NS, ".annotator-filter-next",
                        function(e) {
                            self._onNextClick(e)
                        }).on("click." + NS, ".annotator-filter-clear",
                        function(e) {
                ...
                Filter.prototype.addFilter = function(options) {
                    ...
                    for (var i = 0,
                             len = this.filters.length; i < len; i++) {
                ...
                Filter.prototype.filterHighlights = function() {
                    var activeFilters = $.grep(this.filters,
                        function(filter) {
            ...
            32 : [function(require, module, exports) { (function(global) {
                ...
                Highlighter.prototype.draw = function(annotation) {
                    var normedRanges = [];
                    for (var i = 0,
                             ilen = annotation.ranges.length; i < ilen; i++) {
                    ...
                    for (var j = 0,
                             jlen = normedRanges.length; j < jlen; j++) {
                ...
                Highlighter.prototype.undraw = function(annotation) {
                    ...
                    for (var i = 0,
                             len = annotation._local.highlights.length; i < len; i++) {
            ...
            36 : [function(require, module, exports) { (function(global) {
                ...
                function TextSelector(element, options) {
                    ...
                    if (typeof this.element.ownerDocument !== "undefined" && this.element.ownerDocument !== null) {
                        ...
                        $(this.document.body).on("mouseup." + TEXTSELECTOR_NS,
                            function(e) {
                ...
                TextSelector.prototype._checkForEndSelection = function(event) {
                    ...
                    for (var i = 0,
                             len = selectedRanges.length; i < len; i++) {
                ...
                var Viewer = exports.Viewer = Widget.extend({
                    constructor: function(options) {
                        ...
                        if (this.options.autoViewHighlights) {
                            ...
                            $(this.options.autoViewHighlights).on("mouseover." + NS, ".annotator-hl",
                                function(event) {
                                    if (event.target === this) {
                                        self._onHighlightMouseover(event)
                                    }
                                }).on("mouseleave." + NS, ".annotator-hl",
                                function() {
                                    self._startHideTimer()
                                });
                            $(this.document.body).on("mousedown." + NS,
                                function(e) {
                                    if (e.which === 1) {
                                        self.mouseDown = true
                                    }
                        ...
                        this.element.on("click." + NS, ".annotator-edit",
                            function(e) {
                                self._onEditClick(e)
                            }).on("click." + NS, ".annotator-delete",
                            function(e) {
                    ...
                    load: function(annotations, position) {
                        ...
                        for (var i = 0,
                                 len = this.annotations.length; i < len; i++) {
            ...
            38 : [function(require, module, exports) { (function(global) {
                ...
                function Widget(options) {
                    ...
                    this.classes = $.extend({},
                        Widget.classes, this.constructor.classes);
                    this.options = $.extend({},
                        Widget.options, this.constructor.options, options);
                ...
                Widget.prototype.installExtensions = function() {
                    if (this.options.extensions) {
                        for (var i = 0,
                                 len = this.options.extensions.length; i < len; i++) {
